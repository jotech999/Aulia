...
export async function PanelDireccion({
  ...
  return (
    <div className="animar-surgir">
      ...
      <section className="mt-3 grid grid-cols-1 divide-y divide-borde overflow-hidden rounded-xl border border-borde bg-superficie sm:grid-cols-3 sm:divide-x sm:divide-y-0">
        {[
