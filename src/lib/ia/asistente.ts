...
Usa las herramientas para buscar estudiantes por nombre, listar cursos, resumir asistencia, revisar alertas de riesgo y ver la ficha académica mínima de un estudiante.`;
}
